...
//  Today
//
//  Created by Barbara Luiza Freitas Carmo on 05/05/22.
//
...
#if DEBUG
//diretiva de compilação que impede a compilação do código incluído
//quando você cria o aplicativo para lançamento. Neste caso utilizada
//para amostra de dados em teste debug
